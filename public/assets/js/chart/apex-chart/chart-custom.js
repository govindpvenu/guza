...
var chart = new ApexCharts(
    document.querySelector("#sales-purchase-chart"),
    options,
)
chart.render()
...
var chart = new ApexCharts(
    document.querySelector("#sales-purchase-return-cart"),
    options,
)
chart.render()
...
var chart = new ApexCharts(
    document.querySelector("#total-earnings-chart"),
    options,
)
chart.render()
    ...
    series: [
        {
            ...
            data: [
                45, 40, 140, 70, 150, 260, 240, 380, 110, 180, 270, 115, 70, 65,
                50,
            ],
        },
    ],
