...
//Controllers
const { homePage,productDetails,shopPage,} = require('../controllers/user/userController')
...
const { placeOrder,orderDetails,cancelOrder,successPage} = require("../controllers/user/orderController")
